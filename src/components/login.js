...
export default class Login extends Component {
  ...
  handleSubmit(e) {
    ...
    if (this.newUser)
    {
      ...
      if (this.state.users == null)
      {
        ...
        console.log("user data: " + data.state.username)
  ...
  render() {
    const { username, password, submitted, loading, newUser, error } = this.state;
    return (
      ...
      <div className="form-group">
      <button onClick={this.register} className="btn btn-primary" disabled={loading}>
             Create an Account
      </button>
      {loading && newUser &&
        <img src="data:image/gif;base64," />
